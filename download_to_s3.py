...
from secret_credentials import username, password, access_key_ID, secret_access_ID
import pandas as pd
...
def s3_save_track(
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            if verbose:
                print(
                    "Attachment Successfully save in S3 Bucket, url: %s " % (file_url)
                )
